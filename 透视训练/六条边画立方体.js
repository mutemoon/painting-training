...
function init_canvas() {
    ...
    test_type_info = [
        [
            [function () {
                return new THREE.PlaneGeometry(Math.random() * 3, Math.random() * 3)
            }, 1]
        ],
        [
            [function () {
        ...
        [
            [function () {
                return new THREE.SphereGeometry(Math.random() * 3, Math.random() * 3, Math.random() * 3)
            }, 1]
        ],
        [
            [function () {
        ...
        [
            [function () {
                return new THREE.BoxGeometry(Math.random() * 3, Math.random() * 3, Math.random() * 3)
            }, 1]
        ],
        [
            [function () {
        ...
        [
            ...
            [function () {
                return new THREE.SphereGeometry(Math.random() * 3, Math.random() * 5, Math.random() * 10)
            }, 3]
        ],
    ]

    test_object_material = new THREE.MeshBasicMaterial({
    ...
    sphere = new THREE.Mesh(new THREE.SphereGeometry(1, 100, 100), new THREE.MeshPhongMaterial({
        shininess: 0
    }));
    scene2.add(sphere);
}
